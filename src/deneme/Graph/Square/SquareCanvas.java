...
public class SquareCanvas extends GLCanvas implements GLEventListener {
    ...
    public SquareCanvas(GLCapabilities caps, BlockingQueue<QueueMessage> queue, Simulation simulation) {
        super(caps);
    ...
    public void init(GLAutoDrawable drawable) {
        ...
        // internal format 32-bit float -> gain yuvarlanmaz (8-bit banding/siyah nokta
        // olmaz)
        gl.glTexImage2D(
                GL.GL_TEXTURE_2D,
                0,
    ...
    /**
     * Sol ustte, haritanin 1/4 olcekli aynisi: ayni gain quad'i + scanline,
     * gridsiz.
     */
